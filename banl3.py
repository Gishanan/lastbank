...
def loan_money():
    ...
    accounts[acc_no]["balance"] += amount
    accounts[acc_no]["transactions"].append(f"{datetime} Loan Deposit: +{amount}")
    accounts[acc_no]["loan_money"] += amount  # Keep track of loan money
    save_accounts()
